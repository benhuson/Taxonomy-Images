...
require_once( trailingslashit( dirname( TAXONOMY_IMAGES_FILE ) ) . 'includes/config.php' );

Taxonomy_Images_Config::set_version( '0.9.6' );
Taxonomy_Images_Config::set_plugin_file( TAXONOMY_IMAGES_FILE );

require_once( trailingslashit( dirname( TAXONOMY_IMAGES_FILE ) ) . 'includes/term.php' );
require_once( trailingslashit( dirname( TAXONOMY_IMAGES_FILE ) ) . 'includes/public-filters.php' );
require_once( trailingslashit( dirname( TAXONOMY_IMAGES_FILE ) ) . 'includes/functions.php' );
require_once( trailingslashit( dirname( TAXONOMY_IMAGES_FILE ) ) . 'includes/deprecated.php' );
